...
const Header = () => {
    return (
        <header className="bg-background-dark/80 backdrop-blur-md border-b border-border-dark h-16 px-8 flex flex-shrink-0 items-center justify-between z-10 sticky top-0 w-full">
            <h2 className="text-sm font-medium text-text-secondary">Dashboard / <span className="text-white">Overview</span></h2>
            <div className="flex items-center space-x-4">
                ...
                <a className="text-xs font-medium text-text-secondary hover:text-white transition" href="#">Feedback</a>
                <a className="text-xs font-medium text-text-secondary hover:text-white transition" href="#">Help</a>
            </div>
        </header>
    );
};
